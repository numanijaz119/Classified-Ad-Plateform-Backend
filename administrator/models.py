...
class BannerClick(models.Model):
    """Model to track banner clicks for detailed analytics."""
    ...
    def __str__(self):
        return f'{self.banner.title} - {self.clicked_at}'


class BannerImpression(models.Model):
    """Model to track banner impressions for detailed analytics."""
    ...
    def __str__(self):
        return f'{self.banner.title} - {self.viewed_at}'