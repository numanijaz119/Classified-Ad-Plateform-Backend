...
class Ad(models.Model):
    ...
    view_count = models.PositiveIntegerField(
        _('View Count'),
        default=0,
        help_text=_('Number of times ad has been viewed')
    )
    ...
    def display_price(self):
        ...
        if self.price_type == 'free':
            ...
            price_str = f'${self.price:,.0f}' if self.price == int(self.price) else f'${self.price:,.2f}'
    ...
    def get_analytics_data(self, days=30):
        ...
        daily_views = self.detailed_views.filter(
...
class AdView(models.Model):
    ...
    referrer = models.URLField(
        _('Referrer'),
        blank=True,
        help_text=_('Page that referred to this ad')
    )
